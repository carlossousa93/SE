...
public class CancelOperationMethodTest {
	...
	@Test
	public void sucessDepositedCancelled() throws SibsException, AccountException, OperationException {
		this.sibs.transfer(this.sourceIban, this.targetIban, 100);
		this.sibs.processOperations();
		this.sibs.transfer(this.sourceIban, this.targetIban, 100);
		this.sibs.processOperations();
	...
	@Test
	public void sucessCompletedFailsCancelled() throws SibsException, AccountException, OperationException {
		this.sibs.transfer(this.sourceIban, this.targetIban, 100);
		this.sibs.processOperations();
		this.sibs.transfer(this.sourceIban, this.targetIban, 100);
		this.sibs.processOperations();
	...
	@Test
	public void sucessCancelFailsCancelled() throws SibsException, AccountException, OperationException {
		this.sibs.transfer(this.sourceIban, this.targetIban, 100);
		this.sibs.processOperations();
		this.sibs.cancelOperations(0);
		this.sibs.transfer(this.sourceIban, this.targetIban, 100);
	...
	@Test
	public void sucessFailsNullCancelled() throws SibsException, AccountException, OperationException {
		try {
			this.sibs.cancelOperations(0);
			fail();
