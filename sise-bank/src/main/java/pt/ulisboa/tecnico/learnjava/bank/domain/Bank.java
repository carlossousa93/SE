...
public class Bank {
	...
	public String createAccount(AccountType type, Client client, int amount, int value)
		...
		checkClientInBank(client);

		Account account = accountType(type, client, amount, value);
	...
	public Account accountType(AccountType type, Client client, int amount, int value)
	...
	public void checkClientInBank(Client client) throws BankException {
	...
	public static void main(String[] args) throws BankException, AccountException, ClientException, PersonException {
