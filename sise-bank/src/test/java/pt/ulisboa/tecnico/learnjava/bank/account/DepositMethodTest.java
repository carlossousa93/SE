...
public class DepositMethodTest {
	...
	public void setUp() throws AccountException, ClientException, BankException, PersonException {
		...
		Person person = new Person("João", "Manuel", "Street", "987654321");
		Person young = new Person("João", "Manuel","Street","987654321");
		Client client = new Client(bank, person, "123456789", 33);
		Client youngClient = new Client(bank, young , "123456780", 17);
