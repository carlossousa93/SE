...
public class ExamTests {
	...
	@Before
	public void setUp() throws AccountException, ClientException, BankException, PersonException {
		this.services = new Services();
		this.bank = new Bank("CGD");
		
		this.person = new Person("José", "Manuel", "Street", "987654321");
		this.youngPerson = new Person( "José", "Manuel", "Street", "987654321");

		this.client = new Client(this.bank, this.person, "123456789", 33);
		Client otherClient = new Client(this.bank, this.person, "023456789", 33);
		this.youngClient = new Client(this.bank, this.youngPerson,"123456780", 17);
