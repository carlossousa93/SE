...
public class CreateAccountMethodTest {
	...
	@Before
	public void setUp() throws BankException, ClientException, PersonException {
		this.services = new Services();
		this.bank = new Bank("CGD");
		this.person = new Person("João", "Manuel", "Street", "987654321");
	...
	@Test
	public void successYoungAccount() throws BankException, AccountException, ClientException, PersonException {
		Person young = new Person("João","Manuel","Street","987654321");
		Client youngClient = new Client(this.bank, young, "123456780", 16);
	...
	@Test
	public void failYoungAccountMoreThan17() throws BankException, AccountException, ClientException, PersonException {
		Person young = new Person("João","Manuel","Street","987654321");
		Client notSoYoungClient = new Client(this.bank, young, "123456780", 18);
